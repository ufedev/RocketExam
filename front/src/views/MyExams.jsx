    ...
    try {
      ...
      Swal.fire({
        ...
        if (confirm.isConfirmed) {
          ...
          Swal.fire({
            title: 'Condiciones ✍️',
            html: `<p class='whitespace-pre-line'>Tendran un maximo de 25min, una vez finalizado ese tiempo se enviara automaticamente.\n
                        
                        Si se abre la consola o cambia de pestaña o miniminza el navegador el tiempo correra mas rápido. Por ejemplo si tienen 25min, tendras como maximo 6segundos fuera de la ventana.\n
            ...
            if (confirm.isConfirmed) {
              Swal.fire({
                title: "Reglas 🫷",
                html: `<p class='whitespace-pre-line'>Esta prohibido el uso del celular durante el devsafio, los celulares deben estar en un lugar visible y boca abajo.\n
